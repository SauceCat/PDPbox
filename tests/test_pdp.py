...
def test_pdp_isolate_binary(titanic_model, titanic_data, titanic_features):
    ...
    assert pdp_isolate_out.display_columns == ['0', '7.73', '7.9', '8.66', '13', '16.7', '26', '35.11', '73.5', '512.33']
    ...
    assert_array_almost_equal(pdp_isolate_out.pdp[[1, 5, 9]], np.array([0.34042153, 0.3876946, 0.48316196]), decimal=7)
...
# @pytest.mark.skip(reason="slow")
def test_pdp_isolate_regression(ross_model, ross_data, ross_features):
    pdp_isolate_out = pdp_isolate(
    ...
    ice_lines_expected = pd.DataFrame({0: {0: 8530.777753293662, 200000: 5482.39135417475, 400000: 11795.332507513558,
